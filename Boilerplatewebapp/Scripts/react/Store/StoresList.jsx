...
import DeleteStores from './DeleteStores.jsx';
import CreateStores from './CreateStores.jsx';
import UpdateStores  from './UpdateStores.jsx';
            ...
            tableData = list.map(store =>
                <tr key={store.Id}>
                    ...
                    <td className="four wide">
                        <Button onClick={this.showUpdateModel.bind(this, store.Id)}><i className="edit icon"></i>Edit</Button>
                    </td>

                    <td className="four wide">
                        <Button onClick={this.handleDelete.bind(this, store.Id)}><i className="trash icon"></i>DELETE</Button>
                    </td>
        ...
        return (
            <React.Fragment>
                <div>
                    ...
                    <CreateStores onChange={this.onChange} onClose={this.closeCreateModel} onCreateSubmit={this.onCreateSubmit} showCreateModel={this.state.showCreateModel} />

                </div>

                <div>
                    <UpdateStores onChange={this.onChange} update={this.state.updateId} onClose={this.closeUpdateModel} onUpdateSubmit={this.onUpdateSubmit} showUpdateModel={this.state.showUpdateModel} Id={this.state.StoreId} Name={this.state.StoreName} Address={this.state.StoreAddress} errors={this.state.errors} />

                    <DeleteStores delete={this.state.deleteId} onClose={this.closeDeleteModal} onDeleteSubmit={this.onDeleteSubmit} showDeleteModal={this.state.showDeleteModal} />
